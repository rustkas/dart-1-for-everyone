...
class ComicsCollection extends IterableBase {
  ...
  // Be Backbone like
  Stream<ComicModel> get onLoad => Stream.castFrom<dynamic,ComicModel>(_onLoad.stream);
  Stream<ComicModel> get onAdd => Stream.castFrom<dynamic,ComicModel>(_onAdd.stream);
